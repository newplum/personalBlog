...
function queryLikeBlog (like, page, pageSize, success) {
    var querySql = 'select * from blog where title like ? order by id desc limit ?, ?;';
    var params = [like, page * pageSize, pageSize];
    var connection = dbutil.createConnection();
    connection.connect();
    connection.query(querySql, params, function (error, result) {
        if (error == null) {
...
function queryByLikeCount (like, success) {
...
module.exports.queryLikeBlog = queryLikeBlog;
module.exports.queryByLikeCount = queryByLikeCount;